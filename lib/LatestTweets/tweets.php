...
//	session_start(); 
	...
	function display_latest_tweets(
		...
		// Function parameters.
		$twitter_user_id,
		$cache_file          = 'lib/LatestTweets/tweets.txt',  // Change this to the path of your cache file. (Default : ./tweets.txt)
		...
		$twitter_wrap_open   = '<p class="tweet"><span class="heading">NuMe:</span><br/>',
		$twitter_wrap_close  = '</p>',
		$tweet_wrap_open     = '',
		$meta_wrap_open      = '',
		$meta_wrap_close     = '',
		$tweet_wrap_close    = '',
		$date_format         = '',    // Date formatting. (http://php.net/manual/en/function.date.php)
		...
		$consumerkey         = "SWKdCvLTtAJIxPiI2g4p8Odgo";
		$consumersecret      = "fXGQ0jX0HqtCjB5RD5HXJbrJF7YXg4CBANMDPHxJmWqSFYBorC";
		$accesstoken         = "263305446-XM2GgbY0k8RlPN6kVyDuV29692Z4Od7lBiiuI3ey";
		$accesstokensecret   = "Aaj7ZKJz7wpjfObr3LYvglcJgeykcFMFZq7eyCW0jsLSI";
	...
	display_latest_tweets('numeproducts');
?>
