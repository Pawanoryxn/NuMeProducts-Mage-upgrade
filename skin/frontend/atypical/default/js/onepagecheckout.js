        ...
        if (this.config.triggers) {
            if (this.config.triggers.length != 0) {
                for (var i in this.config.triggers) {
                	if(this.config.triggers[i].el && this.config.triggers[i].el != undefined && typeof(this.config.triggers[i].el) != 'undefined')
                	{
...
function changeSize() {
    ...
    var width_scr = getClientWidth() + scroll;
    form = document.getElementById('onepagecheckout_orderform');
    colmain = form.parentNode;
    var left = colmain.offsetLeft;
    if (width_scr <= 980 && width_scr >= 620) {
        width = width - left;
        colmain.style.width = width + "px";
        col1 = document.getElementsByClassName('col-1');
        col1[0].style.width = 99 + "%";
        col2 = document.getElementsByClassName('col-2');
        col2[0].style.width = 99 + "%";
        col2[0].style.minHeight = 350 + "px";
        col2[0].style.cssFloat = 'right';
        col3 = document.getElementsByClassName('col-3');
        col3[0].style.width = 99 + "%";
    } else if (width_scr <= 620) {
        width = width - left;
        colmain.style.width = width + "px";
        col1 = document.getElementsByClassName('col-1');
        col1[0].style.width = 99 + "%";
        ...
        col1 = document.getElementsByClassName('col-1');
        col1[0].style.width = 27 + "%";
        col2 = document.getElementsByClassName('col-2');
        col2[0].style.width = 33 + "%";
        col2[0].style.minHeight = 450 + "px";
        col2[0].style.cssFloat = 'left';
        col3 = document.getElementsByClassName('col-3');
        col3[0].style.width = 31 + "%";
    }
}
