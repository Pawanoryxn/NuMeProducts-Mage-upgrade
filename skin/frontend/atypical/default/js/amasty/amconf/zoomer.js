...
AmZoomer.prototype = ({
    ...
    loadZoom: function() {
        if(this.generalSettings['zoom_enable'] === "1" || this.generalSettings['lightbox_enable'] === "1") {
            ...
            jQuery("#amasty_zoom").elevateZoom({zoomType : "inner", zoomWindowHeight: 240, zoomWindowWidth: 240, zoomWindowOffsety: 116, borderSize: 0, easing:true})//this.zoomSettings);
    ...
    loadCarousel: function() {
        ...
        if(this.generalSettings['carousel_enable'] === "1"  && $("amasty_zoom")  && $("amasty_gallery")) {
            // $mage is used because jQuery error. $mage is defined  in atypical.js file.
            $mage("#amasty_gallery").carouFredSel(this.carouselSettings);    
        }        
    }
