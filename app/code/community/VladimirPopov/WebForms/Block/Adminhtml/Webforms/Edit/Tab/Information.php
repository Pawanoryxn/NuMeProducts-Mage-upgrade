	...
	extends Mage_Adminhtml_Block_Widget_Form
{
	...
	protected function _prepareForm()
	{
		...
		$fieldset->addField('menu', 'select', array(
			'label'     => Mage::helper('webforms')->__('Display in menu'),
			'title'     => Mage::helper('webforms')->__('Display in menu'),
			'name'      => 'menu',
			'note' => Mage::helper('webforms')->__('Show web-form in admin backend menu'),
