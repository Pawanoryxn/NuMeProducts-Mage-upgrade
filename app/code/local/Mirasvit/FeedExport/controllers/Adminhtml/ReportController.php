...
class Mirasvit_FeedExport_Adminhtml_ReportController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $directRefreshLink = $this->getUrl('*/adminhtml_report/refreshRecent');
