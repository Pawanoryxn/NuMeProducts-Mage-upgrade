...
class Mirasvit_FeedExport_Model_Rule_Condition_Performance extends Mage_Rule_Model_Condition_Abstract
{
    public function loadAttributeOptions()
    {
        $attributes =array(
            ...
            'cr_7'       => Mage::helper('feedexport')->__('Last 7-days Conversation Rate (%)'),
            ...
            'cr_14'      => Mage::helper('feedexport')->__('Last 14-days Conversation Rate (%)'),
            ...
            'cr_30'      => Mage::helper('feedexport')->__('Last 30-days Conversation Rate (%)'),
        );
