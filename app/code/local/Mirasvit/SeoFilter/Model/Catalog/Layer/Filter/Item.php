...
if (Mage::helper('core')->isModuleEnabled('GoMage_Navigation') && class_exists('GoMage_Navigation_Model_Layer_Filter_Item')) {
...
} elseif (Mage::helper('core')->isModuleEnabled('Amasty_Shopby') && class_exists('Amasty_Shopby_Model_Catalog_Layer_Filter_Item')) {
...
} elseif (Mage::helper('core')->isModuleEnabled('Fishpig_AttributeSplash') && class_exists('Fishpig_AttributeSplash_Model_Layer_Filter_Item')) {
