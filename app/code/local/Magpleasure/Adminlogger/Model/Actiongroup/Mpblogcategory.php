 ...
 */
class Magpleasure_Adminlogger_Model_Actiongroup_Mpblogcategory extends Magpleasure_Adminlogger_Model_Actiongroup_Abstract
{
    protected $_typeValue = 49;
    ...
    {
        return $this->_helper()->__("Magpleasure Blog Pro Category");
    }
    ...
    {
        return 'mpblog_admin/adminhtml_category/edit';
    }
