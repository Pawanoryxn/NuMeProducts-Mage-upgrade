...
*/
abstract class Atypicalbrands_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Atypicalbrands_Commercebug_AjaxController','Atypicalbrands_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Atypicalbrands_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
