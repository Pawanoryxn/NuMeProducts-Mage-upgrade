...
*/
class Atypicalbrands_Commercebug_Model_Shim
{
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Atypicalbrands_Commercebug';
    ...
    {
        $full_module_name = 'Atypicalbrands_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Atypicalbrands_Commercebug_Model_Shim;
        }
