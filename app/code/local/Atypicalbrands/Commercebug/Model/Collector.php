...
class Atypicalbrands_Commercebug_Model_Collector extends Mage_Core_Helper_Abstract
{
    ...
    public function registerSingleCollector(Atypicalbrands_Commercebug_Model_Observingcollector $object)
    {
