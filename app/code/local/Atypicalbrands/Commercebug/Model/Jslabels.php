...
class Atypicalbrands_Commercebug_Model_Jslabels extends Mage_Core_Model_Abstract
{	
    ...
    public function getLabels()
    {
        ...
        'lookup'=>array(
            'instructions'  => $this->__($this->getShim()->getTextLookupInstructions()),
        ...
        'system'=>array(
            ...
            'toggle_translate'          => $this->__('Toggle Inline Translation'),
        ),
        );			
    }
