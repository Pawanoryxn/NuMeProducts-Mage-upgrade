...
*/
class Atypicalbrands_Commercebug_Model_Collectorblocksandlayout extends Atypicalbrands_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Atypicalbrands_Commercebug') === 0)
            {
                continue;
            }
