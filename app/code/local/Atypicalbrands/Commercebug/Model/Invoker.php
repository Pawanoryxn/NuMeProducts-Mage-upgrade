...
*/
class Atypicalbrands_Commercebug_Model_Invoker extends Mage_Core_Model_Event_Invoker_InvokerDefault
{
    ...
    public function getCommerceBugCollector()
    {
        ...
        {
            $this->_commerceBugCollector = new Atypicalbrands_Commercebug_Model_Collectorevents;                    
        }
