...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Atypicalbrands_Commercebug><active>true</active><codePool>local</codePool></Atypicalbrands_Commercebug></modules></config>';
        $string = str_replace('Atypicalbrands_', $this->namespace . '_',$string);
