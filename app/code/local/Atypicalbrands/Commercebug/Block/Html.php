...
class Atypicalbrands_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    protected $_config;
    protected function _checkValidScriptPath($scriptPath)
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Atypicalbrands_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Atypicalbrands_Commercebug');
    ...
    {       
        ...
        {
            Atypicalbrands_Commercebug_Model_Shim::Log('Cleanup in ' . __CLASS__ . ': ' . __LINE__ );
    ...
    protected function getConfig()
    {
        ...
        if($shim->isMage2())
        {
            Atypicalbrands_Commercebug_Model_Shim::Log('Cleanup at: ' . __CLASS__ . ' ' . __LINE__);
