...
class Atypicalbrands_Promocampaign_Block_Adminhtml_Promo_Quote_Edit_Tab_Main  
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('name', 'text', array(
            'name' => 'name',
            'label' => Mage::helper('salesrule')->__('Campaign Name'),
            'title' => Mage::helper('salesrule')->__('Campaign Name'),
            'required' => true,
        ));
      $fieldset->addField('publisher', 'text', array(
            'name' => 'publisher',
            'label' => Mage::helper('salesrule')->__('Publisher'),
            'title' => Mage::helper('salesrule')->__('Publisher'),
//            'required' => true,
        ));

       $fieldset->addField('campaign_id', 'text', array(
            'name' => 'campaign_id',
            'label' => Mage::helper('salesrule')->__('Campaign ID'),
            'title' => Mage::helper('salesrule')->__('Campaign ID'),
//            'required' => true,
        ));

       $fieldset->addField('campaign_type', 'select', array(
            'name' => 'campaign_type',
            'label' => Mage::helper('salesrule')->__('Campaign Type'),
            'title' => Mage::helper('salesrule')->__('Campaign Type'),
           'required' => true,
           'options'    => array(
                 '0' => '',
...
//            'required' => true,
    ...
    $fieldset->addField('external_url', 'text', array(
            'name' => 'external_url',
            'label' => Mage::helper('salesrule')->__('Publisher URL'),
            'title' => Mage::helper('salesrule')->__('Publisher URL'),
//            'required' => true,
        ));
        
        $fieldset->addField('createdats', 'text', array(
            'name' => 'createdats',
            'label' => Mage::helper('salesrule')->__('Last Updated'),
            'title' => Mage::helper('salesrule')->__('Last Updated'),
            'readonly' => true
        ));
        
        $fieldset->addField('userupdatelast', 'text', array(
            'name' => 'userupdatelast',
            'label' => Mage::helper('salesrule')->__('Last Update By'),
            'title' => Mage::helper('salesrule')->__('Last Update By'),
            'readonly' => true
        ));
    ...
    $usernames[] = array(
        ...
        $fieldset->addField('ownerofcampaign', 'select', array(
            'name'      => 'ownerofcampaign',
            'label'     => Mage::helper('salesrule')->__('Owner Of Campaign'),
            'title'     => Mage::helper('salesrule')->__('Owner Of Campaign'),
            'required'  => true,
            'values'    => $usernames,
        ));
      ...
      $dateFormatIso = Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);
       ...
       $fieldset->addField('campaign_start_date', 'date', array(
            'name'   => 'campaign_start_date',
            'label'  => Mage::helper('salesrule')->__('Campaign From Date'),
            'title'  => Mage::helper('salesrule')->__('Campaign From Date'),
            'image'  => $this->getSkinUrl('images/grid-cal.gif'),
            'input_format' => Varien_Date::DATE_INTERNAL_FORMAT,
            'format'       => $dateFormatIso
        ));
       
        $fieldset->addField('campaign_end_date', 'date', array(
            'name'   => 'campaign_end_date',
            'label'  => Mage::helper('salesrule')->__('Campaign To Date'),
            'title'  => Mage::helper('salesrule')->__('Campaign To Date'),
            'image'  => $this->getSkinUrl('images/grid-cal.gif'),
            'input_format' => Varien_Date::DATE_INTERNAL_FORMAT,
            'format'       => $dateFormatIso
        ));
