...
class Atypicalbrands_Promocampaign_Block_Adminhtml_Promo_Quote_Edit_Tab_Actions extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions implements Mage_Adminhtml_Block_Widget_Tab_Interface 
{
		...
		protected function _prepareForm()
    	{
			...
			$fieldset->addField('set_flatrate_by_region', 'select', array(
				'label' => Mage::helper('salesrule')->__('Select Flat Rate Shipping by Region'),
				'title' => Mage::helper('salesrule')->__('Select Flat Rate Shipping by Region'),
				'name' => 'set_flatrate_by_region',
				'options' => array(
					'1' => Mage::helper('salesrule')->__('Yes'),
	                '0' => Mage::helper('salesrule')->__('No'),
				),
				'onchange' => 'flatrateRegion_hide()',
			));
			
			$fieldset->addField('set_flatrate_shipping_us', 'text', array(
				'name' => 'set_flatrate_shipping_us',
				'label' => Mage::helper('salesrule')->__('Flat Rate Shipping for US'),
				'note' => Mage::helper('salesrule')->__('Leave blank to use normal shipping rules'),
			));
			$fieldset->addField('set_flatrate_shipping_ca', 'text', array(
				'name' => 'set_flatrate_shipping_ca',
				'label' => Mage::helper('salesrule')->__('Flat Rate Shipping for Canada'),
				'note' => Mage::helper('salesrule')->__('Leave blank to use normal shipping rules'),
			));
			$fieldset->addField('file', 'file', array(
				'name' => 'file',
				'label' => Mage::helper('salesrule')->__('Flat Rate Shipping for Overseas'),
				'note' => Mage::helper('salesrule')->__('Leave blank to use normal shipping rules'),
			));
