...
class Mage_Checkout_Model_Session extends Mage_Core_Model_Session_Abstract
{
    ...
    const CHECKOUT_COMMON_STORE_ID = '1';

    public function getCommonCheckoutStoreId()
    {
        return self::CHECKOUT_COMMON_STORE_ID;
    } 
    ...
    public function getQuote()
    {
        ...
        if ($this->_quote === null) {
            ...
            $quote = Mage::getModel('sales/quote')->setStoreId(Mage::app()->getStore($this->getCommonCheckoutStoreId())->getId());
            if ($this->getQuoteId()) {
                ...
                if ($quote->getId()) {
                     ...
                     * store switcher.
                     */
                    if ($quote->getQuoteCurrencyCode() != Mage::app()->getStore($this->getCommonCheckoutStoreId())->getCurrentCurrencyCode()) {
                        $quote->setStore(Mage::app()->getStore($this->getCommonCheckoutStoreId()));
    ...
    {
        return 'quote_id_' . Mage::app()->getStore($this->getCommonCheckoutStoreId())->getWebsiteId();
    }
    ...
    public function loadCustomerQuote()
    {
        ...
        $customerQuote = Mage::getModel('sales/quote')
            ->setStoreId(Mage::app()->getStore($this->getCommonCheckoutStoreId())->getId())
