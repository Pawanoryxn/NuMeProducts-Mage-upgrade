...
class Company_Web_Block_Adminhtml_Web_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('boxsize', array(
          'header'    => Mage::helper('web')->__('Box Size'),
          'align'     =>'left',
          'index'     => 'boxsize',
      ));

      $this->addColumn('cublicsize', array(
          'header'    => Mage::helper('web')->__('Cubic Size'),
          'align'     =>'left',
          'index'     => 'cublicsize',
      ));
