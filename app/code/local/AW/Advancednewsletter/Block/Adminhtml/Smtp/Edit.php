...
class AW_Advancednewsletter_Block_Adminhtml_Smtp_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_objectId = 'smtp_id';
        $this->_blockGroup = 'advancednewsletter';
        $this->_controller = 'adminhtml_smtp';
    ...
    {
        if (Mage::registry('an_current_smtp') && Mage::registry('an_current_smtp')->getId()) {
            return Mage::helper('advancednewsletter')->__(
                "Edit Item '%s'", $this->escapeHtml(Mage::registry('an_current_smtp')->getTitle())
            );
        } else {
