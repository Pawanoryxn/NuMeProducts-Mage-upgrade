...
class AW_Advancednewsletter_Block_Adminhtml_Template_Edit extends Mage_Adminhtml_Block_Widget
{
    ...
    public function getForm()
    {
        return $this->getLayout()
            ->createBlock('advancednewsletter/adminhtml_template_edit_form')
            ->toHtml()
        ;
    }
