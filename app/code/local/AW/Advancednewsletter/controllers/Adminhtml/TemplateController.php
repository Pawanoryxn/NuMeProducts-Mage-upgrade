...
class AW_Advancednewsletter_Adminhtml_TemplateController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        //TODO: load not the preview layout. Create our own layout
