...
class AW_Marketsuite_Model_Rule_Condition_Order_Purchasedquantity_Conditions extends Mage_Rule_Model_Condition_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setType('marketsuite/rule_condition_order_numberorders_conditions')->setValue(null);
    }
