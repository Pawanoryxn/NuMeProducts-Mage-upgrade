...
class AW_Marketsuite_Model_Rule_Condition_Order_Numberorders extends Mage_Rule_Model_Condition_Combine
{
    ...
    {
        parent::__construct();
        $this->setType('marketsuite/rule_condition_order_numberorders')->setValue(null);
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive(
            ...
            array(
                 array(
                     'value' => 'marketsuite/rule_condition_order_numberorders_conditions|order_status',
                     'label' => Mage::helper('salesrule')->__('Order status'),
                 ),
                 array(
                     'value' => 'marketsuite/rule_condition_order_numberorders_conditions|order_date',
                     'label' => Mage::helper('salesrule')->__('Order date'),
                 ),
                 array(
                     'value' => 'marketsuite/rule_condition_order_numberorders_conditions|order_store_id',
    ...
    public function loadAttributeOptions()
    {
        ...
        $this->setAttributeOption(
            array(
                 'orders_number' => $hlp->__('Orders quantity'),
            )
        );
        return $this;
    }
    ...
    public function asHtml()
    {
        $html = $this->getTypeElement()->getHtml() .
            Mage::helper('salesrule')->__(
                "%s %s %s with %s of these conditions match:",
