...
class AW_Marketsuite_Model_Rule_Condition_Order_Purchasedquantity extends Mage_Rule_Model_Condition_Combine
{
    ...
    {
        parent::__construct();
        $this->setType('marketsuite/rule_condition_order_purchasedquantity')->setValue(null);
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive(
            ...
            array(
                 array(
                     'value' => 'marketsuite/rule_condition_order_purchasedquantity_conditions|order_status',
                     'label' => Mage::helper('salesrule')->__('Order status'),
                 ),
                 array(
                     'value' => 'marketsuite/rule_condition_order_purchasedquantity_conditions|order_date',
                     'label' => Mage::helper('salesrule')->__('Order date'),
                 ),
                 array(
                     'value' => 'marketsuite/rule_condition_order_purchasedquantity_conditions|order_store_id',
    ...
    public function asHtml()
    {
        $html = $this->getTypeElement()->getHtml() .
            Mage::helper('salesrule')->__(
                "%s purchased quantity&nbsp; %s %s with %s of these conditions match:",
    ...
    public function validate(Varien_Object $object)
    {
        if ($object instanceof Mage_Sales_Model_Order) {
            if ($this->_validateConditions($object)) {
                $total = $object->getTotalQtyOrdered();
