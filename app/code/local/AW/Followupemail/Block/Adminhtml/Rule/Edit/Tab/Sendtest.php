...
class AW_Followupemail_Block_Adminhtml_Rule_Edit_Tab_Sendtest extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('test_customer_id', 'text', array(
            ...
            'note'  => $this->__('The ID of the customer') . '<br>' . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField('test_customer_email', 'text', array(
            ...
            'note'  => $this->__('The email of the customer') . '<br>' . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField('order_increment_id', 'text', array(
            ...
            'label' => $this->__('Order #'),
            'title' => $this->__('Order #'),
            'note'  => $this->__('The Increment ID of the order') . '<br>' . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField('test_quote_id', 'text', array(
            ...
            'note'  => $this->__('The ID of the cart') . '<br>' . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField('test_wishlist_id', 'text', array(
            ...
            'note'  => $this->__('The ID of the wishlist') . '<br>' . $this->__('If not specified, random value will be used'),
        ...
        $fieldset->addField('test_product_id', 'text', array(
            ...
            'note'  => $this->__('The ID of the product') . '<br>' . $this->__('If not specified, random value will be used'),
