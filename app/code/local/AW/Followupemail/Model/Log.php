...
class AW_Followupemail_Model_Log
{
    ...
    public static function log(
        $description, $prefix = '         ', $severity = null, $object = null, $message = null, $line = null
    ) {
        ...
        if (is_null($object)) {
            $object = Mage::getSingleton('followupemail/log');
        }
     ...
     * @param string $message Message to log
     */
    public static function logSuccess($message, $object = null, $subject = null)
    {
        $title = self::LOG_MESSAGE_PREFIX_SUCCESS . ' ' . $subject;
        self::log($message, $title, AW_Core_Model_Logger::LOG_SEVERITY_NOTICE, $object);
    }
     ...
     * @param string $message Message to log
     */
    public static function logError($message, $object = null, $subject = null)
    {
        $title = self::LOG_MESSAGE_PREFIX_ERROR . ' ' . $subject;
        self::log($message, $title, AW_Core_Model_Logger::LOG_SEVERITY_ERROR, $object);
