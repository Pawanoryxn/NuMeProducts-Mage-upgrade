    ...
    public function orderPlaceAfter($observer) {
        ...
        if ($account && $account->getId()) {
            ...
            $transactionData = array(
                ...
                // 'total_amount' => $order->getBaseSubtotal() - $order->getShippingAmount() - $order->getTaxAmount(), //$order->getBaseSubtotal(),
				'total_amount' => $order->getBaseSubtotal() - abs($order->getbase_discount_amount()), //$order->getBaseSubtotal(),
