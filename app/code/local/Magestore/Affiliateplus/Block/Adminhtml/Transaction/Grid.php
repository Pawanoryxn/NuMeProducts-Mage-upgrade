...
class Magestore_Affiliateplus_Block_Adminhtml_Transaction_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		$collection ->getSelect()
                ...
                ;
		$collection->getSelect()->columns('(total_amount + discount) as total_amount_discount');
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('total_amount_discount', array(
			'header'    => Mage::helper('affiliateplus')->__('Total Amount'),
			'width'     => '150px',
			'align'     =>'right',
			'index'     => 'total_amount_discount',
			'filter_index'     => 'total_amount + discount',
			'type'  	=> 'price',
