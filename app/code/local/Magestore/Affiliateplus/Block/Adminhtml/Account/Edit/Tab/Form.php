	...
	extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  // showing data in backend 
      $fieldset->addField('youtubechannel', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('YouTube Channel'),
          'name'      => 'youtubechannel',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
      ...
      $fieldset->addField('youtubechannel2', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('YouTube Channel 2'),
          'name'      => 'youtubechannel2',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
          // 'readonly' => 'readonly'
      ...
      $fieldset->addField('affilateblog', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('Blog'),
          'name'      => 'affilateblog',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
      ...
      $fieldset->addField('affilateinstagram', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('Instagram'),
          'name'      => 'affilateinstagram',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
          // 'readonly' => 'readonly'
      ...
      $fieldset->addField('affilatefacebook', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('Facebook'),
          'name'      => 'affilatefacebook',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
          // 'readonly' => 'readonly'
      ...
      $fieldset->addField('affilatetwitter', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('Twitter'),
          'name'      => 'affilatetwitter',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
          // 'readonly' => 'readonly'
      ...
      $fieldset->addField('affilateother', 'text', array(
          'label'     => Mage::helper('affiliateplus')->__('Other Media'),
          'name'      => 'affilateother',
		  //'readonly'  => 'readonly',
          'class'     => 'input-text',
          // 'required'  => true,
