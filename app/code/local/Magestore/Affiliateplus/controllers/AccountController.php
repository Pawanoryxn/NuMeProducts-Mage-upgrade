...
class Magestore_Affiliateplus_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function editPostAction(){
    	...
    	try {
			...
			$customeryoutube = $this->getRequest()->getPost('youtubechannel');
    		$youtubechannel2 = $this->getRequest()->getPost('youtubechannel2');
    		$affilateblog = $this->getRequest()->getPost('affilateblog');
    		$affilateinstagram = $this->getRequest()->getPost('affilateinstagram');
    		$affilatefacebook = $this->getRequest()->getPost('affilatefacebook');
    		$affilatetwitter = $this->getRequest()->getPost('affilatetwitter');
    		$affilateother = $this->getRequest()->getPost('affilateother');
			
    		$account->setData('name',$customer->getName())
    			->setData('paypal_email',$data['paypal_email'])
    			->setData('youtubechannel',$customeryoutube)
    			->setData('youtubechannel2',$youtubechannel2)
    			->setData('affilateblog',$affilateblog)
    			->setData('affilateinstagram',$affilateinstagram)
    			->setData('affilatefacebook',$affilatefacebook)
    			->setData('affilatetwitter',$affilatetwitter)
    			->setData('affilateother',$affilateother)
